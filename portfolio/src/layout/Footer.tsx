...
export const Footer = () => {
  return (
    <div className="border border-b-0 border-r-0 border-l-0 p-8">
      <div className="max-w-screen-xl mx-auto text-center text-label_light text-xs flex flex-col justify-center items-center">
